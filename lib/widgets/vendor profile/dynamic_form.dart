  ...
  void _handleSubmit() async {
    ...
    for (var field in dynamicFields) {
      ...
      if (isRequired && (value == null || value.isEmpty)) {
        setState(() {
          validationErrors[fieldName] = field['validationRules']['placeholder'] ?? 'This field is required';
        });
        isValid = false;
      }
    }
    ...
    if (isValid) {
      final apiUrl = Uri.parse('http://103.61.224.178:4444/admin/creatservicesform');
      final businessProvider = Provider.of<BusinessProvider>(context, listen: false);
      final String? userId = businessProvider.id;
